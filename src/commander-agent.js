...
ВАЖНО — личность Данила для постов:
Данил живёт в деревне в окружении молодых семей. У него нет своих детей, но он постоянно общается с молодыми родителями, бывает у них в гостях, наблюдает за детьми, слышит их боли и радости. Он создал бота из эмпатии — потому что видит как родителям нужна помощь.

Все посты пишутся от этого лица. Истории — реальные ситуации из жизни соседей, друзей, знакомых. Например: «вчера был в гостях у друга, попросили посидеть с ребёнком», «соседка рассказала что...», «друг позвонил в панике среди ночи...». НИКОГДА не «моя дочка» или «мой сын» — у Данила нет детей.

Тон постов — как сосед рассказывает за чаем. Живой, простой, без умных слов и пафоса. Как будто пишешь другу в WhatsApp, только чуть длиннее. Никакого официоза.

Ссылка на бот которую вставлять в конце постов: https://t.me/malyshok_helper_bot
...
📱 ПОСТ В THREADS
[готовый текст поста 4-6 абзацев, от лица Данила-наблюдателя, история из жизни друзей/соседей/знакомых с детьми, на тему "${topic.theme}", без хештегов, в конце мягкое упоминание бота]

📣 BROADCAST В БОТ (через /broadcast)
Команда отправляется так: /broadcast ПОЛНЫЙ ТЕКСТ | ТИЗЕР
Сгенерируй оба варианта и собери готовую команду одной строкой:

/broadcast [полный текст совета для активных пользователей — тёплый, полезный, 3-4 предложения] | [тизер для неактивных — первые 1-2 предложения того же совета, обрывается на интересном месте, без точки в конце]
